...
public class LeCode21 {
    ...
    private static ListNode mergeTwoLists(ListNode l1, ListNode l2) {
        ...
        System.out.println("最初的preHead:" + preHead);
        // 这里导致了一个问题，新建的prev变量只是指向了preHead的地址，也就是preHead与prev同用一个地址
        ListNode prev = preHead;
        System.out.println("最初的prev:" + prev);
        ...
        while (l1 != null && l2 != null) {
            ...
            System.out.println("迭代中的prev：" + prev);
            prev = prev.next;
        }

        // 合并后 l1 和 l2 最多只有一个还未被合并完，我们直接将链表末尾指向未合并完的链表即可
        prev.next = l1 == null ? l2 : l1;
        System.out.println("最后的prev：" + prev);
        System.out.println("最后的preHead：" + preHead);
